...
parser.add_argument("--clip-dir", type=normalized_filepath, default=None, help="Path to directory with CLIP files")
...
parser.add_argument('--clip-path', type=normalized_filepath, help='Checkpoint to use as clip; setting this argument disables all settings related to clip', default=None)
